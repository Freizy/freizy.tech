      ...
      <div className="max-w-[1120px] mx-auto px-5 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-[13px]">
          ...
          <div>
            ...
            <ul className="space-y-2 text-[#424245] dark:text-neutral-400">
              <li><a href="https://omnia.freizy.com" target="_blank" rel="noopener noreferrer" className="hover:underline">Freizy Omnia Suite</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-[#424245] dark:text-neutral-400">
              ...
              <li><a href="mailto:info@freizy.com" className="hover:underline">info@freizy.com</a></li>
              <li><a href="https://freizy.com" target="_blank" rel="noopener noreferrer" className="hover:underline">freizy.com</a></li>
